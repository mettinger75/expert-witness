...
import {
  ...
  FolderOpen, Loader2, X, RefreshCw, Brain, Eye,
} from 'lucide-react'

// Non-medical document categories for the "Other Documents" tab
...
const OTHER_DOCUMENT_CATEGORIES = DOCUMENT_CATEGORIES.filter(c =>
  OTHER_CATEGORIES.includes(c.value)
)
...
export default function OtherDocumentsPage() {
  ...
  const [docCategory, setDocCategory] = useState<string>('correspondence')
  const [docDescription, setDocDescription] = useState('')
  const [docDate, setDocDate] = useState('')
  const fileInputRef = useRef<HTMLInputElement>(null)

  // Fetch documents filtered to other categories
  const filters = {
  ...
  // Client-side filter to only show non-medical categories
  const documents = categoryFilter !== 'all'
    ? allDocuments
    : allDocuments.filter(d => OTHER_CATEGORIES.includes(d.category))
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Pleadings, correspondence, literature, guidelines, and other non-medical documents
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={docCategory} onValueChange={setDocCategory}>
                  ...
                  <SelectContent>
                    {OTHER_DOCUMENT_CATEGORIES.map((c) => (
      ...
      {docsLoading ? (
        ...
        <EmptyState
          ...
          description="Upload pleadings, correspondence, literature, and other non-medical documents."
        />
      ) : (
