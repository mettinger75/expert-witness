      ...
      <div className="min-h-screen bg-[#F0F2F5]">
        ...
        <header className="bg-[#0E1F35] border-b border-[#1C3555]">
          <div className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-3">
            <div className="h-9 w-9 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: '#C9A84C' }}>
            ...
            <div>
              ...
              <div className="text-[#C9A84C] text-xs" style={{ letterSpacing: '0.1em' }}>Expert Witness — Anesthesiology</div>
            </div>
          </div>
        </header>
